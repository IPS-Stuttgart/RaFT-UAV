...
def test_imm_tracker_accepts_zero_dimensional_numeric_timestamps():
    tracker = AsyncInteractingMultipleModelTracker(np.zeros(3), np.array(0.0))

    tracker.predict_to(np.array(1.25))
