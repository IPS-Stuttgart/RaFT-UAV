...
def test_imm_tracker_rejects_invalid_uncertainty_scales(
    parameter: str,
    value: object,
) -> None:
    with pytest.raises(
...
def test_imm_tracker_normalizes_valid_uncertainty_scales() -> None:
    ...
    assert tracker.base_acceleration_std_mps2 == 0.0
