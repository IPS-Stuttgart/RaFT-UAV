...
def test_learned_radar_association_respects_initial_catprob_threshold():
    radar = pd.DataFrame([
        {"frame_index": 0, "track_id": 1, "time_s": 0.0, "east_m": 0.0, "north_m": 0.0, "up_m": 0.0, "cat_prob_uav": 0.2},
        {"frame_index": 0, "track_id": 2, "time_s": 0.0, "east_m": 1.0, "north_m": 0.0, "up_m": 0.0, "cat_prob_uav": 0.3},
    ])
