...
def test_radar_polar_frame_honors_explicit_degree_angle_columns_when_default_is_rad() -> None:
    frame = pd.DataFrame(
        {
            "time_s": [0.0],
            "range_m": [10.0],
...
def test_radar_polar_frame_prefers_explicit_rad_angles_over_degrees_and_generic() -> None:
    frame = pd.DataFrame(
        {
            "time_s": [0.0],
            "range_m": [10.0],
