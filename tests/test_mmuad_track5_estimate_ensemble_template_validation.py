...
def test_track5_estimate_ensemble_rejects_invalid_template_sequence() -> None:
...
def test_track5_estimate_ensemble_rejects_invalid_template_timestamp(
    timestamp: object,
) -> None:
...
def test_track5_estimate_ensemble_does_not_drop_malformed_template_rows() -> None:
    template = pd.concat(
        [
