...
def _candidate_pull_top_k_install() -> Callable[[], None]:
    from raft_uav.mmuad._candidate_pull_top_k_patch import install
...
_optional_runtime_hook(_candidate_pull_top_k_install)
