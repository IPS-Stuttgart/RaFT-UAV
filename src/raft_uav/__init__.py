...
def _class_probability_label_validation_install() -> Callable[[], None]:
    from raft_uav.mmuad._class_probability_label_validation_patch import install
...
_optional_runtime_hook(_class_probability_label_validation_install)
