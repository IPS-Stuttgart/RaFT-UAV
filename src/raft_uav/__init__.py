...
def _evaluator_header_validation_install() -> Callable[[], None]:
    from raft_uav.mmuad._evaluator_header_validation_patch import install
...
_optional_runtime_hook(_evaluator_header_validation_install)
