...
def _template_resample_control_validation_install() -> Callable[[], None]:
    from raft_uav.mmuad._template_resample_control_validation_patch import install
...
_optional_runtime_hook(_template_resample_control_validation_install)
