"""Compatibility wrapper for robust Track 5 class-ensemble template headers.

The maintained implementation lives in the sibling
``track5_class_conditioned_ensemble.py`` module. This package preserves the
public import path while making alias lookup insensitive to surrounding
whitespace, as commonly introduced by spreadsheets and hand-edited CSVs.
"""
...
# Keep the patched private helper visible to tests and exploratory callers.
