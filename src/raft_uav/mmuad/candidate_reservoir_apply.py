...
_ADJUSTED_CSV = "mmuad_candidate_reservoir_adjusted_candidates.csv"
...
def apply_train_selected_reservoir_config(
    ...
    *,
    ...
    ``cap_mode='score'`` exactly reproduces the cap used by the current train-CV
    selector. ``cap_mode='diversity'`` is an explicit ablation that preserves a
    minimum source/branch quota during the final cap.
    """
