"""Console wrapper preserving textual sequence IDs for candidate-mixture mapping."""
...
from raft_uav.mmuad import candidate_mixture_map as _impl
...
def _read_csv_preserving_sequence_id(path: Any, *args: Any, **kwargs: Any):
    """Read CSV inputs without coercing opaque sequence identifiers."""
